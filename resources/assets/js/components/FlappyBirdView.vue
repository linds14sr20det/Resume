<template>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <p>Quick clone of flappy bird. This was based on following a tutorial while learning more about browser based JS games using HTML5's canvas element.</p>
                <p>All credit goes to Max Whilborg. <a href="https://github.com/maxwihlborg">Max Whilborg's GitHub</a></p>
            </div>
        </div>
    </div>
</template>
